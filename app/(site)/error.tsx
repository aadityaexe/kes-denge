  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center pt-24 pb-16">
      <div className="container-site text-center max-w-lg">
        ...
        <h2 className="text-3xl font-display font-semibold text-text-primary mb-3">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <button
            onClick={() => reset()}
            className="px-6 py-2.5 rounded-full bg-emerald-500 hover:bg-emerald-400 text-black font-medium transition-colors text-sm shadow-[0_0_20px_rgba(16,185,129,0.3)]"
          >
            Try again
          </button>
